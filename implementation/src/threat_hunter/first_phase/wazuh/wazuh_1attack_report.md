...
2. [Wazuh System Context](#2-wazuh-system-context)
3. [Alert Log Overview](#3-alert-log-overview)
4. [Authentication Failure Detection](#4-authentication-failure-detection)
  4.1. [SSH Authentication Failures](#41-ssh-authentication-failures)
5. [Privilege Escalation and Sudo Activity](#5-privilege-escalation-and-sudo-activity)
  5.1 [Successful Privileged Sessions](#51-successful-privileged-sessions)
6. [Alert Severity and Classification](#6-alert-severity-and-classification)
7. [Detection Coverage Assessment](#7-detection-coverage-assessment)
